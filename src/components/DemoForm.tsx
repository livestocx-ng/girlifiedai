...
export const DemoForm = ({ onSubmit, isLoading }: DemoFormProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.productName || !formData.productType || !formData.targetCondition) {
      toast({
        title: "Required Fields Missing",
        description: "Please fill in all required fields to run the simulation.",
        variant: "destructive",
      });
      return;
    }
    ...
    <Card className="w-full max-w-4xl mx-auto shadow-scientific">
      <CardHeader className="bg-gradient-scientific text-white">
        ...
        <CardDescription className="text-gray-200">
          Test your health product with our advanced AI models before costly human trials
        </CardDescription>
      </CardHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <Tabs defaultValue="basic" className="w-full">
            ...
            <TabsContent value="basic" className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={formData.productType} onValueChange={(value) => handleInputChange('productType', value)}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="supplement">Dietary Supplement</SelectItem>
                      <SelectItem value="biologics">Biologics/Biosimilar</SelectItem>
                      <SelectItem value="digital-therapeutic">Digital Therapeutic</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="targetCondition">Target Condition *</Label>
                <Input
                  id="targetCondition"
            ...
            <TabsContent value="mechanism" className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="expectedMechanism">Expected Mechanism of Action</Label>
                <Textarea
                  id="expectedMechanism"
                  value={formData.expectedMechanism}
                  onChange={(e) => handleInputChange('expectedMechanism', e.target.value)}
              ...
              <div className="space-y-2">
                <Label htmlFor="previousStudies">Previous Studies/Data</Label>
                <Textarea
                  id="previousStudies"
                  value={formData.previousStudies}
                  onChange={(e) => handleInputChange('previousStudies', e.target.value)}
            ...
            <TabsContent value="safety" className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="riskAssessment">Known Risks & Contraindications</Label>
                <Textarea
                  id="riskAssessment"
          ...
          {isLoading && (
            <div className="space-y-2">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                Running AI simulation across 10,000+ synthetic patients...
              </div>
