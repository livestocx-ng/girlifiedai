			...
			<Card className='shadow-elevated'>
				<CardHeader className='bg-gradient-scientific text-white'>
					<CardTitle className='text-2xl'>
						{productName} - Clinical Simulation Results
					</CardTitle>
			...
			{/* <Tabs defaultValue='efficacy' className='w-full'>
				...
				<TabsContent value='efficacy' className='space-y-6'>
					<div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>
									AI-generated insights for your product
								</CardDescription>
							</CardHeader>
							<CardContent className='space-y-4'>
								<div className='flex items-start gap-3'>
									...
									<div>
										<p className='font-medium'>
											High efficacy in target population
										</p>
										<p className='text-sm text-muted-foreground'>
											78% response rate predicted vs 35%
											placebo
										</p>
									</div>
								</div>
								<div className='flex items-start gap-3'>
									...
									<div>
										...
										<p className='text-sm text-muted-foreground'>
											Peak efficacy at 150mg daily dose
										</p>
									</div>
								</div>
								<div className='flex items-start gap-3'>
									...
									<div>
										...
										<p className='text-sm text-muted-foreground'>
											Lower efficacy in patients over 65
											years
										</p>
									</div>
								</div>
					...
					<Card>
						<CardHeader>
							<CardTitle>
								Sample Clinical Results Visualization
							</CardTitle>
							<CardDescription>
								Generated charts and clinical imagery
							</CardDescription>
						</CardHeader>
						<CardContent>
							<img
								...
								<div className='space-y-3'>
									<div className='flex items-center gap-2'>
										...
										<span className='text-sm'>
											No serious adverse events predicted
										</span>
									</div>
									<div className='flex items-center gap-2'>
										<CheckCircle className='w-4 h-4 text-success' />
									...
									<div className='flex items-center gap-2'>
										...
										<span className='text-sm'>
											Monitor liver function in elderly
											patients
										</span>
									</div>
								</div>
							...
							<ResponsiveContainer width='100%' height={350}>
								...
								>
									...
									<Line
										type='monotone'
										dataKey='Glucose'
										stroke='hsl(var(--chart-safety))'
										strokeWidth={2}
									/>
									<Line
										type='monotone'
										dataKey='Weight'
										stroke='hsl(var(--chart-biomarker))'
										strokeWidth={2}
									/>
								</LineChart>
							</ResponsiveContainer>
