  ...
  const audiences = [
    {
      ...
      description: "Large organizations looking to reduce R&D costs and accelerate drug development pipelines"
    },
    {
      icon: Lightbulb,
      title: "Health-Tech Innovators",
      description: "Technology-driven companies developing next-generation medical devices and digital health solutions"
    },
    {
      icon: Pill,
      title: "Consumer Health Products",
      description: "Companies creating supplements, diagnostics, and consumer health products requiring regulatory approval"
    },
    {
      icon: Rocket,
      title: "Regulatory Navigation Startups",
      description: "Early-stage companies navigating complex FDA/EMA regulations for the first time"
    }
  ];
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground">
            Designed for innovators across the health product development spectrum
          </p>
        </div>
